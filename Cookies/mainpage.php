...
<title>DEE COOKIES</title>
</head>


<body>
    <div class="w3-header w3-container w3-blue-grey w3-padding-30 w3-center ">
     <span class= "w3-text-white w3-jumbo" style= "font-size:calc(2px + 1vw)">Dee Cookies</>
    </div>

<!-- Header image -->
<div style="height:600px;background-image:url('res/images/cookies.jpg');background-size:cover" class="w3-display-container">
<div class="w3-display-bottomleft">
</div>
<div class="w3-display-middle w3-center">
<span class="w3-text-white" style="font-size:50px"><br>A delicious cookies to serve you.</span>
</div>
</div>

    <div class="w3-bar w3-light-grey">
        <a href="newcookies.php" class="w3-bar-item w3-button w3-left">New Cookies</a>
    </div>

     <div class="w3-grid-template">

<?php
foreach($rows as $cookies){
    $name = $cookies['name'];
    $price = $cookies['price'];
    $quantity = $cookies['quantity'];
    ...
    echo "<h5>$name</h5>";
    echo "</header>";
    echo "<img class='w3-image' src=res/images/cookies.png" . " onerror=this.onerror=null;this.src='res/images/photo.png'" . "style='width:100%;height:250px'>" ;
