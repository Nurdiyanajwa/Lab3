...
if (isset($_POST["submit"])){
    ...
    echo "<script>window.location.replace('newcookies.php')</script>";
    }
}
...
<div class="w3-header w3-container w3-blue-grey w3-padding-32 w3-center"> 
        <h1 style="font-size:calc(4px + 2vw);">Dee Cookies</h1>
    </div>
    <div class="w3-blue-grey w3-center w3-border-top w3-border-bottom">
        <p style="font-size:calc(8px + 1vw);;">A delicious cookies to serve you.</p>
    </div>
    ...
    <div class="w3-container w3-padding-64 form-container">
        ...
        <p>New Cookies Registration<p>
    </div>

    <form class="w3-container w3-padding" name="registerForm" action="newcookies.php" method="POST" enctype="multipart/form-data" onsubmit="return confirmDialog()">
       <p> 
